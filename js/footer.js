...
<section class="icons">
	...
	<ul class="no-bullets">
		...
		<li class="essa">
			<a href="#" rel="noopener" class="icon essa">
				<span class="a11y">ESSA Sports Betting Integrity</span>
			</a>
		</li>
		<li class="therapy">
			<a href="#" rel="noopener" class="icon therapy">
				<span class="a11y">Gambling Therapy</span>
			</a>
		</li>
		<li class="gamcare">
			<a href="#" rel="noopener" class="icon gamcare">
				<span class="a11y">Gamcare</span>
			</a>
		</li>
		<li class="gib">
			<a href="#" rel="noopener" class="icon gib">
				<span class="a11y">Government of Gibraltar</span>
			</a>
		</li>
		<li class="commission">
			<a href="#" rel="noopener" class="icon commission">
				<span class="a11y">Gambling Commission</span>
			</a>
		</li>
		<li class="trust">
			<a href="#" rel="noopener" class="icon trust">
...
<section class="social">
	...
	<ul class="no-bullets row">
		<li>
			<a href="#" rel="noopener" class="icon facebook">
				<span class="a11y">Facebook</span>
			</a>
		</li>
		<li>
			<a href="#" rel="noopener" class="icon twitter">
				<span class="a11y">Twitter</span>
			</a>
		</li>
		<li>
			<a href="#" rel="noopener" class="icon youtube">
...
<section class="legal">
	...
	<p><small>Labdrakes Betting &amp; Gaming Ltd. is licensed (<a href="#" rel="noopener">licence no. 0000</a>) and regulated by the British Gambling Commission for persons gambling in Great Britain and LM International Limited, Suites 0-0, 0th Floor, Europort, Gibraltar are licensed (RGL Nos. 000, 000) by the Government of Gibraltar and regulated by the Gibraltar Gambling Commissioner.</small></p>
